...
public class LeatherSwordItem extends SwordItem implements DyeableItem {
    private static final String COLOR_KEY = "color";
    private static final int DEFAULT_COLOR = 0xA06540; // 皮革默认颜色

    public LeatherSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {

...
public class LeatherShovelItem extends ShovelItem implements DyeableItem {
    private static final String COLOR_KEY = "color";
    private static final int DEFAULT_COLOR = 0xA06540; // 皮革默认颜色

    public LeatherShovelItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Settings settings) {
